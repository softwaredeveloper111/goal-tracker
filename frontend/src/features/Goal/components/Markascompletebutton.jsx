  ...
  return (
    <>
      ...
      <button
        ...
        className=" cursor-pointer flex w-fit whitespace-nowrap items-center gap-2 px-4 py-2 border border-[#00ff87]/30 text-[#00ff87] hover:bg-[#00ff87] hover:text-[#0a0a0a] transition-all duration-200 active:scale-95 font-['Space_Grotesk']"
      >
        <svg
          width="14"
          height="14"
        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="w-full max-w-sm bg-[#111] border border-[#1a1a1a] border-t-2 border-t-[#00ff87] p-8">
            ...
            <p className="text-sm text-[#555] font-['Inter'] leading-relaxed mb-8">
              Once marked as complete, the calendar will be locked and this
